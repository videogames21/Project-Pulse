...
| Description: | The Admin wants to send invitation link to students, so that they can join a senior design section.                                                                                                                                                                                                                                                                   |  |  |
| Preconditions: | PRE-1. The Admin is logged into the System.                                                                                                                                                                                                                                                                                                                           |  |  |
| Postconditions: | POST-1. Invitation link is generated and can be sent out however the admin wishes to the students.                                                                                                                                                                                                                                                                    |  |  |
| Main Success Scenario: | The Admin indicates to invite students to join a senior design section. See the Associated Information section for format. See the Associated Information section for the default message. The Admin either confirms to send the invitation (continues the normal flow) or chooses to modify the details (return to step 3). Use case ends.                           |  |  |
| Extensions: | **4a. Input validation rule violation:** 4a1. The System alerts the Admin that an input validation rule is violated and displays the nature and location of the error. 4a2. The Admin corrects the mistake and returns to step 4 of the normal flow. 6a1. The Admin customizes the email content and confirms the message. 6a2. Returns to step 6 of the normal flow. |  |  |
| Priority: | High                                                                                                                                                                                                                                                                                                                                                                  |  |  |
| Frequency of Use: | 1 user, 1 usage per year.                                                                                                                                                                                                                                                                                                                                             |  |  |
| Business Rules: |                                                                                                                                                                                                                                                                                                                                                                       |  |  |
| Associated Information: |                                                                                                                                                                                                                                                                                                                                                                       |  |  |
| Related Use Cases | The student needs to UC-25: Set up a student account after receiving the invitation link.                                                                                                                                                                                                                                                                             |  |  |
| Assumptions: |                                                                                                                                                                                                                                                                                                                                                                       |  |  |
| Open Issues: |                                                                                                                                                                                                                                                                                                                                                                       |  |  |
...
| Preconditions: | PRE-1. The Admin is logged into the System.                                                                                                                                                                                                                                                                                                                                                                                                 |  |  |
| Postconditions: | POST-1. The admin sends out Invitation links to the instructors.                                                                                                                                                                                                                                                                                                                                                                            |  |  |
| Main Success Scenario: | The Admin indicates to invite instructors to register an account. The System validates the Admin’s inputs according to the format defined in the Associated Information of this use case. The Admin either confirms to send the invitation (continues the normal flow) or chooses to modify the details (return to step 3). Use case ends.                                                                                                  |  |  |
...
| Frequency of Use: | 1 user, 1 usage per year.                                                                                                                                                                                                                                                                                                                                                                                                                   |  |  |
| Business Rules: |                                                                                                                                                                                                                                                                                                                                                                                                                                             |  |  |
| Associated Information: | The invitation link shall be unique for each instructor. The Admin shall be able to cancel the use case at any time prior to submitting it.                                                                                                                                                                                                                                                                                                 |  |  |
| Related Use Cases | The instructor needs to UC-30: Set up an instructor account after receiving the invitation link.                                                                                                                                                                                                                                                                                                                                            |  |  |
| Assumptions: |                                                                                                                                                                                                                                                                                                                                                                                                                                             |  |  |
| Open Issues: |                                                                                                                                                                                                                                                                                                                                                                                                                                             |  |  |
